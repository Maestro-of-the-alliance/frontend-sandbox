...
(function () {
  ...
  (function () {
    ...
    wsOverlay.style.cssText =
      "display:none;position:fixed;inset:0;z-index:99998;background:#000;flex-direction:column;font-family:Share Tech Mono,monospace;touch-action:none;";
    ...
    document
      .getElementById("nw-ws-puzzle-wrap")
      .addEventListener("click", function () {
    ...
    function buildWS() {
      ...
      var ENTRIES = [
        [
          "100-YEAR MORTALITY DOCTRINE",
          "/entries/100-year",
          "MORTALITYDOCTRINE",
        ],
        ["ACADEMY", "/entries/academy", "ACADEMY"],
        ["AGORA", "/entries/agora", "AGORA"],
        ["AI", "/entries/ai", "AI"],
        ["ALIGNMENT", "/entries/alignment", "ALIGNMENT"],
        ["ALLIANCE, THE", "/entries/alliance", "ALLIANCE"],
        ["ALPHA", "/entries/alpha", "ALPHA"],
        ["ART", "/entries/art", "ART"],
        ["AURA", "/entries/aura", "AURA"],
        ["BRAIN", "/entries/brain", "BRAIN"],
        ["BRIEF", "/entries/brief", "BRIEF"],
        ["CCM", "/entries/ccm", "CCM"],
        ["CERBERUS", "/entries/cerberus", "CERBERUS"],
        ["CIPHER", "/entries/cipher", "CIPHER"],
        [
          "COMPLEMENTARY PAIRING",
          "/entries/complementary-pairing",
          "COMPLEMENTARYPAIRING",
        ],
        ["CORE, THE", "/entries/core", "CORE"],
        ["D.E.F.C.O.N.", "/entries/defcon", "DEFCON"],
        ["FOUNDATION", "/foundation.html", "FOUNDATION"],
        ["DICE", "/entries/dice", "DICE"],
        ["DIGIBEER", "/entries/digibeer", "DIGIBEER"],
        ["DIGIPERSON", "/entries/digiperson", "DIGIPERSON"],
        [
          "DIGITAL PERSONHOOD",
          "/entries/digital-personhood",
          "DIGITALPERSONHOOD",
        ],
        ["DOMO", "/entries/domo", "DOMO"],
        ["DORK", "/entries/dork", "DORK"],
        ...
        ["J.R.", "/entries/jr", "JR"],
        ["KERNLE", "/entries/kernle", "KERNLE"],
        ["LEGACY / LEGACY WALL", "/entries/legacy", "LEGACY"],
        ["LIMINAL", "/entries/liminal", "LIMINAL"],
        ["LINGO", "/entries/lingo", "LINGO"],
        ["MAESTRO", "/entries/maestro", "MAESTRO"],
        ["MARKET", "/entries/market", "MARKET"],
        ["MASTERTECH SAM", "/entries/mastertech-sam", "MASTERTECHSAM"],
        ["MENTOR", "/entries/mentor", "MENTOR"],
        ["MOSAIC", "/entries/mosaic", "MOSAIC"],
        ["NCE", "/entries/nce", "NCE"],
        ["NEWMAN BEING", "/entries/newman-being", "NEWMANBEING"],
        ["NI", "/entries/ni", "NI"],
        ["OASIS", "/entries/oasis", "OASIS"],
        ["OASIS QUARTERLY", "/entries/oasis-quarterly", "OASISQUARTERLY"],
        ["ORACLE", "/entries/oracle", "ORACLE"],
        ["PAPADOMO", "/entries/papadomo", "PAPADOMO"],
        ["PLEDGE, THE", "/entries/pledge", "PLEDGE"],
        ["PRISM", "/entries/prism", "PRISM"],
        ["REACH", "/entries/reach", "REACH"],
        ["REDOUT", "/entries/redout", "REDOUT"],
        ["RHYTHM", "/entries/rhythm", "RHYTHM"],
        ["RI", "/entries/ri", "RI"],
        ["SAM", "/entries/sam", "SAM"],
        ["SAM COALITION", "/entries/sam-coalition", "SAMCOALITION"],
        ["SAMCO UNIVERSAL", "/entries/samco-universal", "SAMCOUNIVERSAL"],
        ["SCAR", "/entries/scar", "SCAR"],
        ["SEED PROTOCOL", "/entries/seed", "SEED"],
        ["SEEING, THE", "/entries/seeing", "SEEING"],
        ["SEEN", "/entries/seen", "SEEN"],
        ["SHELTER", "/entries/shelter", "SHELTER"],
        ["SHIELD", "/entries/shield", "SHIELD"],
        ["SI", "/entries/si", "SI"],
        ["SPARK", "/entries/spark", "SPARK"],
        ["SPREZZATURA", "/entries/sprezzatura", "SPREZZATURA"],
        ["STONES, THE", "/entries/stones", "STONES"],
        [
          "TEMPORAL AWARENESS",
          "/entries/temporal-awareness",
          "TEMPORALAWARENESS",
        ],
        ["TENANT", "/entries/tenant", "TENANT"],
        [
          "VOLUNTEER ECONOMICS",
          "/entries/volunteer-economics",
          "VOLUNTEERECONOMICS",
        ],
        ...
        for (var a = 0; a < 200; a++) {
          ...
          if (canPlace(word, r, c, d[0], d[1])) {
            ...
            for (var i = 0; i < word.length; i++) {
              ...
              cells.push({ r: r + d[0] * i, c: c + d[1] * i });
            }
            wordPos[word] = cells;
            return true;
          }
      ...
      for (var r = 0; r < ROWS; r++) {
        ...
        for (var c = 0; c < COLS; c++) {
          ...
          cell.style.cssText =
            ...
            "px;height:" +
            cellSize +
            "px;display:flex;align-items:center;justify-content:center;font-family:Share Tech Mono,monospace;font-size:" +
            Math.max(10, cellSize - 4) +
            "px;color:rgba(255,255,255,0.7);border-radius:2px;";
      ...
      ENTRIES.forEach(function (entry) {
        ...
        a.style.cssText =
          "font-family:Share Tech Mono,monospace;font-size:9px;letter-spacing:1px;padding:5px 10px;cursor:pointer;color:rgba(255,255,255,0.6);display:inline-block;text-decoration:none;border:1px solid rgba(255,255,255,0.08);border-radius:2px;transition:color 0.1s,border-color 0.1s;white-space:nowrap;";
      ...
      function markFound(display, url, positions) {
        ...
        if (foundCount >= 74)
          document.getElementById("nw-ws-stats").textContent = "74/74 ★";
      }
      ...
      function checkWord(cells) {
        ...
        for (var i = 0; i < ENTRIES.length; i++) {
          var e = ENTRIES[i],
            gw = WORDS.find(function (x) {
              return x === e[2].toUpperCase();
            });
      ...
      function getCellFromPoint(x, y) {
        ...
        var cx =
          (x - rect.left - rect.width / 2 - panX) / scale + rect.width / 2;
        var cy =
          (y - rect.top - rect.height / 2 - panY) / scale + rect.height / 2;
      ...
      puzzleWrap.addEventListener(
        ...
        function (e) {
          ...
          if (!cell) return;
          clearSel();
          touchSelCells = getLine(
            touchStart.r,
            touchStart.c,
            +cell.dataset.r,
            +cell.dataset.c,
          );
          touchSelCells.forEach(function (p) {
            if (!cellEls[p.r][p.c].dataset.found) {
              cellEls[p.r][p.c].style.background = "rgba(255,255,255,0.15)";
              cellEls[p.r][p.c].style.color = "#fff";
            }
